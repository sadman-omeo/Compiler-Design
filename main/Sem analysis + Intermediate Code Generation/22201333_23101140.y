...
statement : variable_decl
	  ...
	  | expression_statement
	  {
			...
			ExprStmtNode* exprStmt = new ExprStmtNode(dynamic_cast<ExprNode*>($1->get_ast_node()));
	  ...
	  | FOR LPAREN expression_statement expression_statement expression RPAREN statement
	  {
			...
			// Create AST node for for loop: this is the ForNode construction
			ForNode* forNode = new ForNode(
				dynamic_cast<ExprNode*>($3->get_ast_node()),
				dynamic_cast<ExprNode*>($4->get_ast_node()),
				dynamic_cast<ExprNode*>($5->get_ast_node()),
				dynamic_cast<StmtNode*>($7->get_ast_node())
			);
...
expression_statement : SEMICOLON
			{
				...
				// An empty expression statement has no expression
